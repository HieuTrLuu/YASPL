...
happyExpList = Happy_Data_Array.listArray (0,196) ([8000,257,1024,0,0,0,41960,33,0,0,0,0,0,0,0,16384,287,1,32768,53248,49223,59392,24995,0,0,512,0,32000,17460,5760,536,8000,257,36768,128,720,64,360,33,4596,16,1,0,0,0,25,16384,3359,33,16,0,32768,0,0,0,0,0,0,32000,1028,0,8192,8000,257,1440,134,18384,2115,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseCalc","Exp","Type","':'","var","bool","true","false","stream","int","if","else","for","in","lam","'>'","'<'","'+'","'-'","'*'","'='","';'","'('","')'","'['","']'","'{'","'}'","%eof"]
        bit_start = st * 31
        bit_end = (st + 1) * 31
...
action_13 (7) = happyShift action_21
...
action_21 (6) = happyShift action_23
...
happyReduction_3 (HappyTerminal (TokenStream _ happy_var_1))
	 =  HappyAbsSyn4
		 (TmStream happy_var_1
	)
